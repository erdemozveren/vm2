...
const bridgeScript = compileScript(pa.join(__dirname,'bridge.js'),
	`(function(global) {"use strict"; const exports = {};${fs.readFileSync(pa.join(__dirname,'bridge.js'), 'utf8')}\nreturn exports;})`);
const setupSandboxScript = compileScript(pa.join(__dirname,'setup-sandbox.js'),
	`(function(global, host, bridge, data, context) { ${fs.readFileSync(pa.join(__dirname,'setup-sandbox.js'), 'utf8')}\n})`);
